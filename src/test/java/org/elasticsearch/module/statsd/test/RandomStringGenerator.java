...
public class RandomStringGenerator
{
	...
	/**
	 * <p>
	 * <code>RandomStringUtils</code> instances should NOT be constructed in standard programming. Instead, the class should be
	 * used as <code>RandomStringUtils.random(5);</code>.
	 * </p>
	 * <p/>
	 * <p>
	 ...
	 * <p/>
	 * <p>
	 * Characters will be chosen from the set of characters whose ASCII value is between <code>32</code> and <code>126</code>
	 * (inclusive).
	 * </p>
	 * 
	 * @param count
	 ...
	 *            the length of random string to create
	 * @param letters
	 *            if <code>true</code>, generated string will include alphabetic characters
	 * @param numbers
	 *            if <code>true</code>, generated string will include numeric characters
	 * @return the random string
	 */
	 ...
	 * instead of using an externally supplied source of randomness, it uses the internal static {@link Random} instance.
	 * </p>
	 * 
	 * @param count
	 *            the length of random string to create
	 ...
	 *            only allow numbers?
	 * @param chars
	 *            the set of chars to choose randoms from. If <code>null</code>, then it will use the set of all chars.
	 * @return the random string
	 * @throws ArrayIndexOutOfBoundsException
	 *             if there are not <code>(end - start) + 1</code> characters in the set array.
	 */
